...
<p>Below is the command I used to build my project into the image in Docker.</p>
...
<p>Below is a screenshot of the command I used for running the image I just built.</p>
...
<p>Below we can see that the image was successfully created and exists in Docker.</p>
<p>Successfully Created Image<br><img width="1123" alt="CreatedImage" src="https://github.com/user-attachments/assets/318385eb-a415-459b-90d0-a1f0b82b0917">
</p>
<p>From running the image in Docker, a container was generated which we can see in this screenshot. Running this container launches my pollapp application.</p>
